...
namespace CodeQuery.Interfaces
{
    public interface IDbQueryable<TSource>
    {
        ...
        // IDbQueryable2<TSource, TSource2> InnerJoin<TSource2>(IDbTable<TSource2> join, Expression<Func<TSource, TSource2, bool>> condition = null);
        IDbQueryable2<TSource, TSource2> InnerJoin<TSource2>(IDbQueryable<TSource2> join, Expression<Func<TSource, TSource2, bool>> condition = null);
        
        IDbQueryable2<TSource, TSource2> LeftJoin<TSource2>(IDbQueryable<TSource2> join, Expression<Func<TSource, TSource2, bool>> condition = null);
        IDbQueryable2<TSource, TSource2> RightJoin<TSource2>(IDbQueryable<TSource2> join, Expression<Func<TSource, TSource2, bool>> condition = null);
        IDbQueryable2<TSource, TSource2> CrossJoin<TSource2>(IDbQueryable<TSource2> join, Expression<Func<TSource, TSource2, bool>> condition = null);
